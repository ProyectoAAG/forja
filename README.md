...
- **Rutina Push / Pull / Pierna / Acondicionamiento** y también Full Body, Core, Movilidad y Piscina.
- **Registro de series, repeticiones y peso** en cada ejercicio, con la máquina que uses (o su alternativa si está ocupada).
- **Botón de completado** por ejercicio y barra de progreso de la sesión.
- **Calendario con rachas** y resumen mensual: ve de un vistazo tu constancia.
...
1. Abre el enlace de la app en el móvil (Chrome en Android, Safari en iPhone).
2. **Android:** menú (⋮) → *Instalar aplicación*.
3. **iPhone:** Compartir → *Añadir a pantalla de inicio*.
4. Ábrela desde el icono. ¡Listo!
...
- Para no perderlos al cambiar de móvil, usa **Configuración → Copia de seguridad → Exportar** y guárdate el archivo.
...
- Cero dependencias externas. Cero build. Cero configuración.

---

## ⚠️ Aviso

Proyecto personal hecho por afición. **No sustituye a un entrenador ni a un profesional de la salud.** Las rutinas son orientativas; si tienes dudas sobre tu técnica o tu estado físico, consulta con un profesional.
